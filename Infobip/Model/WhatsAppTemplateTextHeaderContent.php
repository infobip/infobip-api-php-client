...
/**
 * WhatsAppTemplateTextHeaderContent Class Doc Comment
 *
 * @category Class
 * @package  Infobip
 * @author   Infobip Support
...
class WhatsAppTemplateTextHeaderContent extends WhatsAppTemplateHeaderContent
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppTemplateTextHeaderContent';
     ...
     * Sets placeholder
     *
     * @param string $placeholder Value of a placeholder in the text header.
     *
     * @return self
     */
