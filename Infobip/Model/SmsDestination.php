 ...
 */
class SmsDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsDestination';
     ...
     * Sets to
     *
     * @param string $to Message destination address. Addresses must be in international format (Example: `41793026727`).
     *
     * @return self
     */
