 ...
 */
class MessageStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageStatus';
     ...
     * Sets groupName
     *
     * @param string|null $groupName Group name for the status.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Action that should be taken to fix the error.
     *
     * @return self
     */
