...
class WhatsAppInteractiveOrderStatusContent
{
    /**
     */
    public function __construct(
        #[Assert\Valid]
        #[Assert\NotBlank]
        protected \Infobip\Model\WhatsAppInteractiveOrderStatusActionContent $action,
        #[Assert\Valid]
    ...
    public function getAction(): \Infobip\Model\WhatsAppInteractiveOrderStatusActionContent
    {
        return $this->action;
    }

    public function setAction(\Infobip\Model\WhatsAppInteractiveOrderStatusActionContent $action): self
    {
        $this->action = $action;
        return $this;
    }
