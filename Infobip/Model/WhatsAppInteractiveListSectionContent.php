...
/**
 * WhatsAppInteractiveListSectionContent Class Doc Comment
 *
 * @category Class
 ...
 */
class WhatsAppInteractiveListSectionContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppInteractiveListSectionContent';
    ...
    protected static $openAPITypes = [
        'title' => 'string',
        'rows' => '\Infobip\Model\WhatsAppInteractiveRowContent[]'
    ];
     ...
     * Sets title
     *
     * @param string|null $title Title of the section. Required, if the message has more than one section.
     *
     * @return self
     */
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 24)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WhatsAppInteractiveListSectionContent., must be smaller than or equal to 24.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WhatsAppInteractiveListSectionContent., must be bigger than or equal to 0.');
        }
