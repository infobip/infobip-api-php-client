...
/**
 * WhatsAppVideoContent Class Doc Comment
 *
 * @category Class
 ...
 */
class WhatsAppVideoContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppVideoContent';
     ...
     * Sets mediaUrl
     *
     * @param string $mediaUrl URL of a video sent in a WhatsApp message. Must be a valid URL starting with `https://` or `http://`. Supported video types are `MP4`, `3GPP`. Maximum video size is 16MB.
     *
     * @return self
     */
    public function setMediaUrl($mediaUrl)
    {
        if ((mb_strlen($mediaUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $mediaUrl when calling WhatsAppVideoContent., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($mediaUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mediaUrl when calling WhatsAppVideoContent., must be bigger than or equal to 1.');
        }
     ...
     * Sets caption
     *
     * @param string|null $caption Caption of the video.
     *
     * @return self
     */
    public function setCaption($caption)
    {
        if (!is_null($caption) && (mb_strlen($caption) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $caption when calling WhatsAppVideoContent., must be smaller than or equal to 3000.');
        }
        if (!is_null($caption) && (mb_strlen($caption) < 0)) {
            throw new \InvalidArgumentException('invalid length for $caption when calling WhatsAppVideoContent., must be bigger than or equal to 0.');
        }
