...
class ViberDefaultSmsFailover
{
    ...
    public function __construct(
        ...
        #[Assert\Valid]
        protected ?\Infobip\Model\ViberRegionalOptions $regional = null,
    ) {
    ...
    public function getRegional(): \Infobip\Model\ViberRegionalOptions|null
    {
        return $this->regional;
    }

    public function setRegional(?\Infobip\Model\ViberRegionalOptions $regional): self
    {
