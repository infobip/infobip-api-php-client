...
/**
 * WhatsAppInteractiveButtonsDocumentHeaderContent Class Doc Comment
 *
 * @category Class
 * @package  Infobip
 * @author   Infobip Support
...
class WhatsAppInteractiveButtonsDocumentHeaderContent extends WhatsAppInteractiveButtonsHeaderContent
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppInteractiveButtonsDocumentHeaderContent';
    ...
    public function setMediaUrl($mediaUrl)
    {
        if ((mb_strlen($mediaUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $mediaUrl when calling WhatsAppInteractiveButtonsDocumentHeaderContent., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($mediaUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mediaUrl when calling WhatsAppInteractiveButtonsDocumentHeaderContent., must be bigger than or equal to 1.');
        }
     ...
     * Sets filename
     *
     * @param string|null $filename Filename of the document.
     *
     * @return self
     */
    public function setFilename($filename)
    {
        if (!is_null($filename) && (mb_strlen($filename) > 240)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling WhatsAppInteractiveButtonsDocumentHeaderContent., must be smaller than or equal to 240.');
        }
        if (!is_null($filename) && (mb_strlen($filename) < 0)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling WhatsAppInteractiveButtonsDocumentHeaderContent., must be bigger than or equal to 0.');
        }
