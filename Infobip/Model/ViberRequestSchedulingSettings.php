...
class ViberRequestSchedulingSettings
{
    ...
    public function __construct(
        ...
        #[Assert\Valid]
        protected ?\Infobip\Model\ViberSendingSpeedLimit $sendingSpeedLimit = null,
    ) {
    ...
    public function getSendingSpeedLimit(): \Infobip\Model\ViberSendingSpeedLimit|null
    {
        return $this->sendingSpeedLimit;
    }

    public function setSendingSpeedLimit(?\Infobip\Model\ViberSendingSpeedLimit $sendingSpeedLimit): self
    {
