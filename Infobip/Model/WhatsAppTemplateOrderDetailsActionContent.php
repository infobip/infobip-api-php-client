...
class WhatsAppTemplateOrderDetailsActionContent
{
    /**
     */
    public function __construct(
        #[Assert\Valid]
        #[Assert\NotBlank]
        protected \Infobip\Model\WhatsAppTemplateAllowedOrderPaymentDetails $payment,
        #[Assert\NotBlank]
    ...
    public function getPayment(): \Infobip\Model\WhatsAppTemplateAllowedOrderPaymentDetails
    {
        return $this->payment;
    }

    public function setPayment(\Infobip\Model\WhatsAppTemplateAllowedOrderPaymentDetails $payment): self
    {
