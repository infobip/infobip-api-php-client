...
final class HmacAlgorithm implements EnumInterface
{
    ...
    public static function MD5(): HmacAlgorithm
    {
        return new self('HMAC_MD5');
    }

    public static function SHA_1(): HmacAlgorithm
    {
        return new self('HMAC_SHA_1');
    }

    public static function SHA_224(): HmacAlgorithm
    {
        return new self('HMAC_SHA_224');
    }

    public static function SHA_256(): HmacAlgorithm
    {
        return new self('HMAC_SHA_256');
    }

    public static function SHA_384(): HmacAlgorithm
    {
        return new self('HMAC_SHA_384');
    }

    public static function SHA_512(): HmacAlgorithm
    {
