...
class MessagesApiMessage implements MessagesApiRequestMessagesOneOf
{
    /**
    ...
    public function __construct(
        ...
        #[Assert\Valid]
        #[Assert\NotBlank]
        protected \Infobip\Model\MessagesApiMessageContent $content,
        #[Assert\Valid]
    ...
    public function getContent(): \Infobip\Model\MessagesApiMessageContent
    {
        return $this->content;
    }
