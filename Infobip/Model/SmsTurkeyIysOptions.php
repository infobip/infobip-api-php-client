...
/**
 * SmsTurkeyIysOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class SmsTurkeyIysOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsTurkeyIysOptions';
    ...
    public const RECIPIENT_TYPE_BIREYSEL = 'BIREYSEL';
    public const RECIPIENT_TYPE_TACIR = 'TACIR';
    ...
    {
        return [
            self::RECIPIENT_TYPE_BIREYSEL,
            self::RECIPIENT_TYPE_TACIR,
        ];
    }
     ...
     * Sets brandCode
     *
     * @param int|null $brandCode Brand code is an ID of the company based on a company VAT number. If not provided in request, default value is used from your Infobip account.
     *
     * @return self
     */
     ...
     * Sets recipientType
     *
     * @param string $recipientType Recipient Type must be `TACIR` or `BIREYSEL`.
     *
     * @return self
     */
