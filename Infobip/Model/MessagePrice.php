...
/**
 * MessagePrice Class Doc Comment
 *
 * @category Class
 * @package  Infobip
 * @author   Infobip Support
 ...
 */
class MessagePrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePrice';
     ...
     * Sets currency
     *
     * @param string|null $currency The currency in which the price is displayed.
     *
     * @return self
     */
     ...
     *
     * @param double|null $pricePerMessage The price per individual  message.
     *
     * @return self
     */
