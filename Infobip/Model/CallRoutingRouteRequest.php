...
class CallRoutingRouteRequest
{
    ...
    /**
     * @param \Infobip\Model\CallRoutingSearchCriteria[]|null $criteria List of criteria used to match a route. For a route to match, any criterion should be met.
     */
