...
/**
 * WhatsAppInteractiveButtonsVideoHeaderContent Class Doc Comment
 *
 * @category Class
 * @package  Infobip
 * @author   Infobip Support
...
class WhatsAppInteractiveButtonsVideoHeaderContent extends WhatsAppInteractiveButtonsHeaderContent
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppInteractiveButtonsVideoHeaderContent';
    ...
    public function setMediaUrl($mediaUrl)
    {
        if ((mb_strlen($mediaUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $mediaUrl when calling WhatsAppInteractiveButtonsVideoHeaderContent., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($mediaUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mediaUrl when calling WhatsAppInteractiveButtonsVideoHeaderContent., must be bigger than or equal to 1.');
        }
