...
/**
 * WhatsAppVideoMessage Class Doc Comment
 *
 * @category Class
 * @package  Infobip
 * @author   Infobip Support
 ...
 */
class WhatsAppVideoMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppVideoMessage';
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'messageId' => 'string',
        'content' => '\Infobip\Model\WhatsAppVideoContent',
        'callbackData' => 'string',
        'notifyUrl' => 'string'
    ];
    ...
    public function setFrom($from)
    {
        if ((mb_strlen($from) > 24)) {
            throw new \InvalidArgumentException('invalid length for $from when calling WhatsAppVideoMessage., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($from) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from when calling WhatsAppVideoMessage., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($to) > 24)) {
            throw new \InvalidArgumentException('invalid length for $to when calling WhatsAppVideoMessage., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to when calling WhatsAppVideoMessage., must be bigger than or equal to 1.');
        }
    ...
    public function setMessageId($messageId)
    {
        if (!is_null($messageId) && (mb_strlen($messageId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $messageId when calling WhatsAppVideoMessage., must be smaller than or equal to 50.');
        }
        if (!is_null($messageId) && (mb_strlen($messageId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $messageId when calling WhatsAppVideoMessage., must be bigger than or equal to 0.');
        }
     ...
     * Gets content
     *
     * @return \Infobip\Model\WhatsAppVideoContent
     */
     ...
     * Sets content
     *
     * @param \Infobip\Model\WhatsAppVideoContent $content content
     *
     * @return self
     */
    ...
    public function setCallbackData($callbackData)
    {
        if (!is_null($callbackData) && (mb_strlen($callbackData) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $callbackData when calling WhatsAppVideoMessage., must be smaller than or equal to 4000.');
        }
        if (!is_null($callbackData) && (mb_strlen($callbackData) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callbackData when calling WhatsAppVideoMessage., must be bigger than or equal to 0.');
        }
    ...
    public function setNotifyUrl($notifyUrl)
    {
        if (!is_null($notifyUrl) && (mb_strlen($notifyUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $notifyUrl when calling WhatsAppVideoMessage., must be smaller than or equal to 2048.');
        }
        if (!is_null($notifyUrl) && (mb_strlen($notifyUrl) < 0)) {
            throw new \InvalidArgumentException('invalid length for $notifyUrl when calling WhatsAppVideoMessage., must be bigger than or equal to 0.');
        }
